...
/* -- Part 8 = Statistiques par ville --
----------------------------------------
	
- view/home.php :
	* afficher, en dessous de la liste des sessions, un tableau montrant le nombre d'étudiants par ville
	
- index.php :
	* faire la requête permettant d'avoir le nombre d'étudiant par ville

*/

/* -- Part 9 = Liste pour 1 session --
--------------------------------------
